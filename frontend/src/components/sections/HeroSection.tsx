...
const heroImages = [
  ...
  "/images/hero-adventure.jpg",
  "/images/hero-cenote.jpg",
];
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 max-w-6xl mx-auto mt-8 sm:mt-12">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 leading-relaxed max-w-4xl mx-auto drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] text-gray-100 px-2">
            Donde la naturaleza se une con la aventura y tus vacaciones acaban
            de recibir una mejora épica. Descubre playas paradisíacas, aguas
            cristalinas y experiencias únicas en los destinos más espectaculares
            del Caribe.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16">
          <div className="text-center backdrop-blur-sm bg-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20">
            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-cyan-300 mb-1 sm:mb-2">
              15+
            </div>
            <div className="text-xs sm:text-sm md:text-base opacity-90">
              🏝️ Destinos Paradisíacos
            </div>
          </div>
          <div className="text-center backdrop-blur-sm bg-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20">
            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-blue-300 mb-1 sm:mb-2">
              100K+
            </div>
            <div className="text-xs sm:text-sm md:text-base opacity-90">
              🌊 Aventureros Felices
          ...
          <div className="text-center backdrop-blur-sm bg-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20">
            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-emerald-300 mb-1 sm:mb-2">
              100%
            </div>
            <div className="text-xs sm:text-sm md:text-base opacity-90">
          ...
          <div className="text-center backdrop-blur-sm bg-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20">
            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-teal-300 mb-1 sm:mb-2">
              24/7
            </div>
            <div className="text-xs sm:text-sm md:text-base opacity-90">
              🏖️ Soporte
